      ...
      function render() {
        container.innerHTML = `
          <div class="flex justify-between items-center mb-4">
            ...
            <button id="new-bundle-btn" class="bg-rose-600 text-white px-5 py-2 rounded-full font-semibold hover:bg-rose-700">
                  ...
                  bundles.length === 0
                    ...
                    <tr class="border-t border-gray-100">
                      ...
                      <td class="px-4 py-3 text-right">
                        <button data-edit="${b.id}" class="text-rose-600 font-semibold hover:underline mr-3">Editar</button>
        ...
        el.innerHTML = `
          ...
          <form id="bundle-form" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="sm:col-span-2 border-t pt-4 mt-2">
              ...
              <p class="text-sm text-gray-500">El sistema calcula el total automáticamente: <span id="bundle-total-display" class="font-bold text-rose-600">${initialTotal}</span> piezas</p>
            </div>
