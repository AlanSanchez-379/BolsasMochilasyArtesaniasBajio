          ...
          <div class="p-6">
            ...
            <form id="bundle-form" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div class="sm:col-span-2 border-t pt-4 mt-2">
                ...
                <p class="text-sm text-gray-500">El sistema calcula el total automáticamente: <span id="bundle-total-display" class="font-bold text-brand-mexican">${initialTotal}</span> piezas</p>
              </div>
